...
xla::PjRtClient::KeyValueGetCallback ToCppKeyValueGetCallback(
  ...
  return [c_callback, user_arg](
    ...
    if (error == nullptr) {
      ...
      (*args.value_delete_callback)(args.value);
      return result;
    }
    return error->status;
  };
