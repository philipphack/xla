...
TEST(PjRtCApiHelperTest, Callback) {
  ...
  auto c_kv_get = ToCKVGetCallback(&kv_callback_data->kv_get_c_func);
  auto c_kv_put = ToCKVPutCallback(&kv_callback_data->kv_put_c_func);
  auto converted_back_kv_get =
      ToCppKeyValueGetCallback(c_kv_get, &kv_callback_data->kv_get_c_func);
  auto converted_back_kv_put =
      ToCppKeyValuePutCallback(c_kv_put, &kv_callback_data->kv_put_c_func);
