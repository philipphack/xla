...
TEST_F(CudnnNormRewriterTest, LayerNormTrainBackward2D1) {
  ...
  const char* hlo_text = R"(
    ...
    ENTRY test {
        ...
        norm_factor_scale_doutput = f32[2,4] multiply(norm_factor_bcast, scale_doutput)
        minus_norm_factor_scale_doutput = f32[2,4] negate(norm_factor_scale_doutput)
        minus_norm_factor_scale_doutput_sum = f32[2] reduce(minus_norm_factor_scale_doutput, c0), dimensions={1}, to_apply=apply
        minus_f1_norm_factor_scale_doutput_sum = f32[2] add(minus_f1_sum, minus_norm_factor_scale_doutput_sum)
        minus_f1_norm_factor_scale_doutput_sum_scaled = f32[2] multiply(minus_f1_norm_factor_scale_doutput_sum, r_nelems_bcast)
        minus_f1_norm_factor_scale_doutput_sum_scaled_bcast = f32[2,4] broadcast(minus_f1_norm_factor_scale_doutput_sum_scaled), dimensions={0}
        f1_norm_factor_scale_doutput = f32[2,4] add(f1, norm_factor_scale_doutput)
        dinput = f32[2,4] add(f1_norm_factor_scale_doutput, minus_f1_norm_factor_scale_doutput_sum_scaled_bcast)
...
TEST_F(CudnnNormRewriterTest, LayerNormTrainBackward4D3) {
  ...
  const char* hlo_text = R"(
    ...
    ENTRY test {
        ...
        norm_factor_scale_doutput = f32[2,4,6,8] multiply(norm_factor_bcast, scale_doutput)
        minus_norm_factor_scale_doutput = f32[2,4,6,8] negate(norm_factor_scale_doutput)
        minus_norm_factor_scale_doutput_sum = f32[2,4,6] reduce(minus_norm_factor_scale_doutput, c0), dimensions={3}, to_apply=apply
        minus_f1_norm_factor_scale_doutput_sum = f32[2,4,6] add(minus_f1_sum, minus_norm_factor_scale_doutput_sum)
        minus_f1_norm_factor_scale_doutput_sum_scaled = f32[2,4,6] multiply(minus_f1_norm_factor_scale_doutput_sum, r_nelems_bcast)
        minus_f1_norm_factor_scale_doutput_sum_scaled_bcast = f32[2,4,6,8] broadcast(minus_f1_norm_factor_scale_doutput_sum_scaled), dimensions={0,1,2}
        f1_norm_factor_scale_doutput = f32[2,4,6,8] add(f1, norm_factor_scale_doutput)
        dinput = f32[2,4,6,8] add(f1_norm_factor_scale_doutput, minus_f1_norm_factor_scale_doutput_sum_scaled_bcast)
...
TEST_F(CudnnNormRewriterTest, LayerNormTrainBackward4D2) {
  ...
  const char* hlo_text = R"(
    ...
    ENTRY test {
        ...
        norm_factor_scale_doutput = f32[2,4,6,8] multiply(norm_factor_bcast, scale_doutput)
        minus_norm_factor_scale_doutput = f32[2,4,6,8] negate(norm_factor_scale_doutput)
        minus_norm_factor_scale_doutput_sum = f32[2,4,8] reduce(minus_norm_factor_scale_doutput, c0), dimensions={2}, to_apply=apply
        minus_f1_norm_factor_scale_doutput_sum = f32[2,4,8] add(minus_f1_sum, minus_norm_factor_scale_doutput_sum)
        minus_f1_norm_factor_scale_doutput_sum_scaled = f32[2,4,8] multiply(minus_f1_norm_factor_scale_doutput_sum, r_nelems_bcast)
        minus_f1_norm_factor_scale_doutput_sum_scaled_bcast = f32[2,4,6,8] broadcast(minus_f1_norm_factor_scale_doutput_sum_scaled), dimensions={0,1,3}
        f1_norm_factor_scale_doutput = f32[2,4,6,8] add(f1, norm_factor_scale_doutput)
        dinput = f32[2,4,6,8] add(f1_norm_factor_scale_doutput, minus_f1_norm_factor_scale_doutput_sum_scaled_bcast)
...
TEST_F(CudnnNormRewriterTest, LayerNormTrainBackward4D12) {
  ...
  const char* hlo_text = R"(
    ...
    ENTRY test {
        ...
        norm_factor_scale_doutput = f32[2,4,6,8] multiply(norm_factor_bcast, scale_doutput)
        minus_norm_factor_scale_doutput = f32[2,4,6,8] negate(norm_factor_scale_doutput)
        minus_norm_factor_scale_doutput_sum = f32[2,8] reduce(minus_norm_factor_scale_doutput, c0), dimensions={1,2}, to_apply=apply
        minus_f1_norm_factor_scale_doutput_sum = f32[2,8] add(minus_f1_sum, minus_norm_factor_scale_doutput_sum)
        minus_f1_norm_factor_scale_doutput_sum_scaled = f32[2,8] multiply(minus_f1_norm_factor_scale_doutput_sum, r_nelems_bcast)
        minus_f1_norm_factor_scale_doutput_sum_scaled_bcast = f32[2,4,6,8] broadcast(minus_f1_norm_factor_scale_doutput_sum_scaled), dimensions={0,3}
        f1_norm_factor_scale_doutput = f32[2,4,6,8] add(f1, norm_factor_scale_doutput)
        dinput = f32[2,4,6,8] add(f1_norm_factor_scale_doutput, minus_f1_norm_factor_scale_doutput_sum_scaled_bcast)
