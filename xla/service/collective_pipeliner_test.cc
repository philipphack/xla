...
while_body {
  ...
  dynamic-slice = bf16[1,1,2,128] dynamic-slice(get-tuple-element.k, four_minus_loop_index, c0, c0, c0), dynamic_slice_sizes={1,1,2,128}
  ...
  ROOT tuple = (s32[], bf16[3,8,128], bf16[3,1,2,128]) tuple(next_loop_index, updated_partial_output, get-tuple-element.k), control-predecessors={add}
}
